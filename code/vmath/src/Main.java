...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("Sine of 0.523599 radians: " + vmath.Trigonometry.sin(vmath.Trigonometry.degreeToRadian(30), Angle.RADIAN));
        System.out.println("Cosine of 0.523599 radians: " + vmath.Trigonometry.cos(vmath.Trigonometry.degreeToRadian(30), Angle.RADIAN));
        System.out.println("Tangent of 0.523599 radians: " + vmath.Trigonometry.tan(vmath.Trigonometry.degreeToRadian(30), Angle.RADIAN));
        System.out.println("Cotangent of 0.523599 radians: " + vmath.Trigonometry.cot(vmath.Trigonometry.degreeToRadian(30), Angle.RADIAN));
        System.out.println(("Cosecant of 0.523599 radians: " + vmath.Trigonometry.cosec(vmath.Trigonometry.degreeToRadian(30), Angle.RADIAN)));
        System.out.println("Secant of 0.523599 radians: " + vmath.Trigonometry.sec(vmath.Trigonometry.degreeToRadian(30), Angle.RADIAN));
        System.out.println("____________________________________________\n\n\n\n");
        ...
        System.out.println("Arc-tangent of sqrt of 3: " + vmath.Trigonometry.arctan((vmath.algebra.sqrt(3)), Angle.DEGREE));
        System.out.println("Arc cotangent of sqrt of 3: " + vmath.Trigonometry.arccot((vmath.algebra.sqrt(3)), Angle.DEGREE));
        ...
        System.out.println("\n");
        System.out.println("Matrix E Inverse: ");
        vmath.matrix.inverse(e).printMatrix();
        System.out.println("\n");
        ...
        double[] datav1 = {1, 2, 3};
        double[] datav2 = {4, 5, 6};
        double[][] datav3 = {{2, 1, 1}, {1, 3, 2}, {1, 2, 4}};

        vector va = new vector(datav1);
        vector vb = new vector(datav2);
        Matrix vc = new Matrix(datav3);

        System.out.println("Vector A + Vector B: ");
        vmath.Vector.add(va, vb).printVector();
        System.out.println("\n");
        System.out.println("Vector B - Vector A: ");
        vmath.Vector.subtract(vb, va).printVector();
        System.out.println("\n");
        System.out.println("Vector A . Vector B: ");
        System.out.println(vmath.Vector.scalerProduct(va, vb));
        System.out.println("\n");
        System.out.println("Vector A x Vector B: ");
        vmath.Vector.vectorProduct(va, vb).printVector();
        System.out.println("\n");
        System.out.println("Vector A x Matrix C: ");
        vmath.Vector.multiply(va, vc).printVector();
        System.out.println("\n");
        System.out.println("Compare Vector A and Vector B: "+ vmath.Vector.compare(va, vb));
        System.out.println("\n");
        System.out.println("Magnitude of Vector A: "+ vmath.Vector.magnitude(va));
        System.out.println("\n");
        System.out.println("Unit Vector of Vector A: ");
        vmath.Vector.unitVector(va).printVector();
        System.out.println("\n");
        ...
        System.out.println("Bitwise Left Shift of 5 by 2: " + vmath.bitwise.leftShift(5, 2, signType.SIGNED));
        System.out.println("Bitwise Right Shift of 5 by 2: " + vmath.bitwise.rightShift(5, 2, signType.SIGNED));
        System.out.println("Bitwise Zero Fill Right Shift of 5 by 2: " + vmath.bitwise.zeroFillRightShift(5, 2));
        System.out.println("Bitwise Get Byte of 32 at 2nd position: " + vmath.bitwise.getByte(32, 2, signType.SIGNED));
        System.out.println("Bitwise Set bit 0 at 5th position of 12: " + vmath.bitwise.setBit0(12, 5));
        System.out.println("Bitwise Set bit 1 at 5th position of 12: " + vmath.bitwise.setBit1(12, 5));
        System.out.println("Bitwise Toggle bit at 5th position of 12: " + vmath.bitwise.toggleBit(12, 5));
        System.out.println("Bitwise Logical Shift Left of 12 by 2: " + vmath.bitwise.logicalShift(12, 2, signType.SIGNED));
        System.out.println("Bitwise Right Rotate of 12 by 2: " + vmath.bitwise.rightRotate(12, 2, signType.SIGNED));
        System.out.println("Bitwise Left Rotate of 12 by 2: " + vmath.bitwise.leftRotate(12, 2, signType.SIGNED));
        System.out.println("Bitwise adding 12 and 13 overflows: " + vmath.bitwise.addOK(1, 1, signType.SIGNED));
